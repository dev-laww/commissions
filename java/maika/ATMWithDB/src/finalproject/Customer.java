...
public class Customer {
    ...
    public Customer(String name, String address, String email, String contactNo, String accountID, String pin) {
        this.name = name;
    ...
    public String toString() {
        return String.format("Name: %s%nAddress: %s%nAccount ID: %s%nPin: %s%nBalance: %.2f%n", this.name, this.address, this.accountID, this.pin, this.balance);
    }
}
